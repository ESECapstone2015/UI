...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        comBx = new QComboBox(centralWidget);
        comBx->setObjectName(QStringLiteral("comBx"));
        comBx->setGeometry(QRect(560, 490, 69, 22));
        comBx->setMaxVisibleItems(15);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        comBx->clear();
        comBx->insertItems(0, QStringList()
         << QApplication::translate("MainWindow", "Test1", 0)
         << QApplication::translate("MainWindow", "Test2", 0)
        );
    } // retranslateUi
